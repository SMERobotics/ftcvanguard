...
<button class="w-full min-w-[282px] select-none text-(--inactive) hover:text-(--active) flex-col {alliance === 'red' ? 'bg-[#371a19] hover:bg-[#3e201f]' : ''} {alliance === 'blue' ? 'bg-[#1B223a] hover:bg-[#202846]' : ''} {alliance !== 'red' && alliance !== 'blue' ? 'hover:bg-(--immediate)' : ''} rounded-md pt-1.25 pb-1 px-2 font-mono" onclick={onSelect}>
    <div class="flex">
